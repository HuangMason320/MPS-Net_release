...
from lib.models import MPSnet, MotionDiscriminator, mpsnet
...
def main(cfg):
    ...
    for param in Fix_generator.regressor.parameters():
        param.requires_grad = False 
    # Fix_generator.regressor.decpose.weight.requires_grad = True 
    # Fix_generator.regressor.decshape.weight.requires_grad = True 
    # Fix_generator.regressor.deccam.weight.requires_grad = True
    
    for param_name, param_value in Fix_generator.regressor.named_parameters():
        print(f"Parameter name: {param_name}, requires_grad: {param_value.requires_grad}")
